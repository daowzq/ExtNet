 ...
 */
    ...
    (function () {
        ...
        var findLocation = function findLocation() {
            var reFirebugFile = /(firebug-lite(?:-\w+)?(?:\.js|\.jgz|-js))(?:#(.+))?/;            
            var rePath = /^(.*\/)/;
            var reProtocol = /^\w+:\/\//;
            var path = null;
            var doc = document;
    ...
    FBL.ns(function () {
        with(FBL) {
            var WindowDefaultOptions = {
                ...
                lastSelectedPanelName, focusCommandLineState = 0,
                lastFocusedPanelName, lastHSplitterMouseMove = 0,
    ...
    function DomplateLoop() {}(function () {
        var womb = null;
        ...
        DomplateTag.prototype = {
            ...
            compileDOM: function () {
                ...
                for (var i = 0;
                i < path.staticIndex; ++i) {
                    fnBlock.push(", ", "s" + i)
                }
                for (var i = 0;
                i < path.renderIndex; ++i) {
                    fnBlock.push(", ", "d" + i)
                }
                fnBlock.push(") {");
                for (var i = 0;
            ...
            Firebug.Spy = extend(Firebug.Module, {
                ...
                updateOption: function (name, value) {
                    if (name == "showXMLHttpRequests") {
                        ...
                        for (var i = 0;
                        i < TabWatcher.contexts.length; ++i) {
