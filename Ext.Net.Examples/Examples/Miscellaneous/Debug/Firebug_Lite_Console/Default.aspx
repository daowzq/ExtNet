...
<head runat="server">
    <title>Firebug Lite Debug Console - Ext.NET Examples</title>    
    <link href="../../../../resources/css/examples.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form runat="server">
        <ext:ResourceManager runat="server" DebugConsole="Firebug" />
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server">
                            <Items>
                                <ext:ButtonGroup 
                                    ...
                                    <Items>
                                        <ext:Button 
                                            ...
                                            Text="Show Console"
                                            Width="100" 
                                            OnClientClick="Ext.net.Debug.show();" 
                                            />
                                        ...
                                        <ext:Button 
                                            ...
                                            Text="Hide Console" 
                                            Width="100" 
                                            OnClientClick="Ext.net.Debug.hide();" 
                                            />
                                        ...
                                        <ext:Button 
                                            ...
                                            Text="Log Message" 
                                            Width="100" 
                                            OnClientClick="Ext.net.Debug.log(new Date());" 
                                            />
                                    </Items>
                                </ext:ButtonGroup>
                                <ext:ButtonGroup 
                                ...
                                <ext:HyperLink 
                                    runat="server" 
                                    Text="Firebug Lite Docs" 
                                    Icon="Help"
                                    NavigateUrl="http://getfirebug.com/lite.html" 
                                    Target="_blank" 
                                    Width="150"
